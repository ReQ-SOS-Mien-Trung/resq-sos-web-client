...
const NOTIFICATION_TYPE_LABELS: Record<string, string> = {
  ...
  sos_companion: "Đồng hành SOS",
  depot_advance: "Tạm ứng kho",
  closure_transfer_completed: "Phiên chuyển kho đóng hoàn tất",
  closure_transfer_shipped: "Phiên chuyển kho đóng đã vận chuyển",
  inventory_disposal: "Thanh lý hàng tồn kho",
  inventory_expiring_alert: "Cảnh báo hàng sắp hết hạn",
  depot_relief_imported: "Nhập hàng cứu trợ vào kho",
  depot_purchase_imported: "Nhập hàng mua vào kho",
  coordinator_join: "Điều phối viên tham gia",
  coordinator_leave: "Điều phối viên rời đi",
  mission_assigned: "Nhiệm vụ được phân công",
  assembly_event_cancelled: "Sự kiện tập kết bị hủy",
  assembly_point_closed: "Điểm tập kết đã đóng",
  evacuation_alert: "Cảnh báo sơ tán",
  team_assigned: "Đội được phân công",
  member_left_team: "Thành viên rời đội",
};
...
const NOTIFICATION_TYPE_TONES: Record<string, NotificationTone> = {
  ...
  sos_companion: "info",
  depot_advance: "info",
  closure_transfer_completed: "success",
  closure_transfer_shipped: "info",
  inventory_disposal: "warning",
  inventory_expiring_alert: "warning",
  depot_relief_imported: "success",
  depot_purchase_imported: "success",
  coordinator_join: "info",
  coordinator_leave: "warning",
  mission_assigned: "info",
  assembly_event_cancelled: "danger",
  assembly_point_closed: "warning",
  evacuation_alert: "danger",
  team_assigned: "info",
