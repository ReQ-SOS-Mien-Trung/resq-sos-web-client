...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      classNames={{
        // Root — needs relative so nav can be absolute across both months
        root: "relative",
        months: "flex flex-col sm:flex-row gap-4",
        month: "flex flex-col gap-4",
        // Caption row for each month
        month_caption: "flex justify-center pt-1 items-center h-7",
        caption_label: "text-sm font-medium",
        // Nav sits at root level in v9 — span full width, prev left / next right
        nav: "absolute top-3 left-0 right-0 flex items-center justify-between px-1 z-10",
        button_previous: cn(
